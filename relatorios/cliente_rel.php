...
$pdf->SetName("Relatório de Clientes","ROMANO.NET - Pizzaria online"); // Cabeçalho do Relatório
...
$pdf->Cell(35,6,'CLIENTE','B',0,'C');
$pdf->Cell(35,6,'ENDEREÇO','B',0,'C');
...
$pdf->Cell(35,6,pg_fetch_result($res,$i,'cliente'),1,0,'C');
